...
CREATE TABLE IF NOT EXISTS cuentacorrienteproveedorcredito (
    cuentacorrienteproveedorcredito_id INT(11) NOT NULL 
        AUTO_INCREMENT PRIMARY KEY
    , fecha DATE
    , hora TIME
    , referencia TEXT
    ...
    , INDEX (chequeproveedordetalle_id)
    , transferenciaproveedordetalle_id INT(11)
    , INDEX (transferenciaproveedordetalle_id)
    , usuario_id INT(11)
    , INDEX (usuario_id)
) ENGINE=InnoDb;

CREATE TABLE IF NOT EXISTS movimientocajatipo (
    movimientocajatipo_id INT(11) NOT NULL 
        AUTO_INCREMENT PRIMARY KEY
    , codigo VARCHAR(100)
    , tipo VARCHAR(100)
    , destino VARCHAR(100)
...
CREATE TABLE IF NOT EXISTS movimientocaja (
    movimientocaja_id INT(11) NOT NULL 
        AUTO_INCREMENT PRIMARY KEY
    , fecha DATE
    , hora TIME
    , numero VARCHAR(100)
    ...
    , usuario_id INT(11)
    , INDEX (usuario_id)
    , movimientocajatipo INT(11)
    , INDEX (movimientocajatipo)
    , FOREIGN KEY (movimientocajatipo)
