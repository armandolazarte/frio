...
class CuentaCorrienteProveedorCreditoController {
	...
	function consultar($arg) {
		...
		$select = "cccp.cuentacorrienteproveedorcredito_id AS CTACTEPROCREID, cccp.fecha AS FECHA, cccp.referencia AS REFERENCIA, FORMAT(cccp.importe, 2,'de_DE') AS BALANCE, FORMAT(cccp.movimiento, 2,'de_DE') AS MOVIMIENTO";
		$from = "cuentacorrienteproveedorcredito cccp";
