...
class StockController {
	...
	function update_num_factura() {
		...
		$where = "s.fecha = e.fecha AND s.hora = e.hora AND e.egreso_id = ed.egreso_id AND e.egreso_id = eafip.egreso_id AND e.fecha BETWEEN '2022-03-01' AND '2022-06-01' AND e.tipofactura IN (1,3) AND eafip.tipofactura = tf.tipofactura_id";
