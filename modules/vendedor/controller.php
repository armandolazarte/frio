...
class VendedorController {
	...
	function estadisticas() {
		...
		foreach ($ventas_vendedor_tipo_factura as $clave=>$valor) {
			$ventas_vendedor_tipo_factura[$clave]['TBL_BLANCO'] = number_format($valor['BLANCO'], 2, ',', '.');
			$ventas_vendedor_tipo_factura[$clave]['TBL_NEGRO'] = number_format($valor['NEGRO'], 2, ',', '.');
			$ventas_vendedor_tipo_factura[$clave]['TBL_TOTAL'] = number_format($valor['TOTAL'], 2, ',', '.');
		}
