...
class cobrosPDF extends View {
    ...
    public function descarga_cobros_vendedor($fecha, $total, $cobrador_id, $cobrador_denominacion, $fecha_cobranza, $cobros_array) {
        ...
        $gui_html = str_replace('{fecha_sys}', $fecha_cobranza, $gui_html);
